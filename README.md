...
- Append `?quality=high` or `?quality=low` to lock a tier while profiling. Automatic quality sampling ignores intentional idle throttling and never destroys a healthy WebGL context.
